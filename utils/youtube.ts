...
export const DEFAULT_ELEMENTS: YoutubeElement[] = [
    ...
    {
        id: 'tabs',
        selector: "//ytd-feed-filter-chip-bar-renderer[@component-style='FEED_FILTER_CHIP_BAR_STYLE_TYPE_DEFAULT']/..",
        checked: false,
        property: DISPLAY,
        style: DISPLAY_NONE,
        pageTypes: [PAGE_TYPES.HOME],
    ...
    },
    {
        id: 'you-btn',
        selector:
            "(//div[@id='header']/ytd-guide-entry-renderer)[2] | //ytd-mini-guide-entry-renderer[a[@href='/feed/you']]",
        checked: false,
        property: DISPLAY,
        style: DISPLAY_NONE,
        pageTypes: [],
    ...
    },
    {
        id: 'trending-btn',
        selector:
            "//ytd-guide-entry-renderer[a[@href='/feed/trending']] | //ytd-mini-guide-entry-renderer[a[@href='/feed/trending']]",
        checked: false,
        property: DISPLAY,
        style: DISPLAY_NONE,
        pageTypes: [],
    ...
    },
    {
        ...
        selector:
            "//ytd-guide-section-renderer[not(.//a[@href='/']) and .//a[@href='/feed/subscriptions']]//ytd-guide-entry-renderer[not(.//a[@href='/feed/subscriptions'])] | //ytd-guide-section-renderer[not(.//a[@href='/']) and .//a[@href='/feed/subscriptions']]//ytd-guide-collapsible-entry-renderer",
        checked: false,
        property: DISPLAY,
        style: DISPLAY_NONE,
        pageTypes: [],
    ...
    {
        id: 'lowercase-title',
        selector: "//ytd-watch-metadata//div[@id='title'] | //*[@id='video-title']",
        checked: false,
    ...
    },
    {
        ...
        selector:
            "//button[contains(@aria-label, 'like this video')]/ancestor::segmented-like-dislike-button-view-model",
        checked: false,
        property: DISPLAY,
        style: DISPLAY_NONE,
        pageTypes: [PAGE_TYPES.VIDEO],
